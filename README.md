<table width="100%" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td width="50%" valign="top" style="padding: 10px;">
      <div style="border: 1px solid #30363d; border-radius: 12px; padding: 20px; background: #0d1117; text-align:center;">
        <a href="https://github.com/your-username/windows-server-lab" target="_blank" style="text-decoration:none; color:inherit; display:block;">
          ...
          <p style="font-size: 14px; color: #8b949e; margin: 15px 0;">
    ...
    <td width="50%" valign="top" style="padding: 10px;">
      <div style="border: 1px solid #30363d; border-radius: 12px; padding: 20px; background: #0d1117; text-align:center;">
        <a href="https://github.com/your-username/mikrotik-lab" target="_blank" style="text-decoration:none; color:inherit; display:block;">
